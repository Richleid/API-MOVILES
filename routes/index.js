...
router.get('/clientes/:cli_id',getClienteById)
router.get('/clientes/nombre/:cli_nombre', getClienteByName);

router.post('/clientes/nuevo',postCliente)
router.put('/clientes/actualizar',  putCliente)
router.delete('/clientes/eliminar/:cli_id', deleteCliente)
